...
<script>
	//add kriteria table
	function kripen_add(){
		FBModal_show2( 'proc/kriteriaPenilaian.php', 'post', "proc=add-modal", 
			true, true, null,
			{onSuccess:	function (res){			//install spinner
				spinner_attach('bobotSpinner', 'bobot');
			}
		});
	}
	...
	function kripen_edit(id){
		FBModal_show2( 'proc/kriteriaPenilaian.php', 'post', "proc=edit-modal&kripenID="+id, 
			true, true, null,
			{onSuccess:	function (res){			//install spinner 
			spinner_attach('bobotSpinner', 'bobot', 0, 100, $('bobotSpinner').get('spinnerValue'));
			}
		});
	}
