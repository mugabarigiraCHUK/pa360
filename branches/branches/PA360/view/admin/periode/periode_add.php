...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
	...
	<tr>
		...
		<td><input class="dtpick" name="periodeAwal" /></td>
	</tr>
	<tr>
		<td align="right">Periode akhir :</td>
		<td><input class="dtpick" name="periodeAkhir" /></td>
	</tr>
	<tr>
      <td align="right">Batas penilaian awal :</td>
	  <td><input class="dtpick" name="batasAwal" /></td>
	  </tr>
	<tr>
      <td align="right">Batas pernilaian akhir :</td>
	  <td><input class="dtpick" name="batasAkhir" /></td>
	  </tr>
	<tr>
