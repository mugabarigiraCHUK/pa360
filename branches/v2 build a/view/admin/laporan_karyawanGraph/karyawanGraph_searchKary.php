<form id="frmModal" name="frmModal" method="post" action="proc/admin/laporan_detil.php">
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
	<tr>
		...
		<td><input type="text" name="searchKey" style="width:100%" onkeyup="searchKary_updateTable($('frmModal'))" ></td>
	</tr>
	<tr>
		<td width="100" valign="top">Departemen : </td>
		<td>
			<?php $departemenID = ''; ?>
			<select name="departemenID" onchange="searchKary_updateTable($('frmModal'))">
...
<table style="border:1px solid #457A3F;" width="100%" border="0" cellpadding="5" cellspacing="0">
  ...
  <? include 'karyawanGraph_searchKaryTable.php' ?>
  </tbody>
</table>
</div>
