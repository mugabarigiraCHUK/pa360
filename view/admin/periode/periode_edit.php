...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
	...
	<tr>
		...
		<td><input id="periodeAkhir" class="dtpick" name="periodeAkhir" value="<?=strtotime($row['PERIODE_AKHIR'])?>" /></td>
	</tr>
	<tr>
      <td align="right">Batas penilaian awal :</td>
	  <td><input id="batasAwal" class="dtpick" name="batasAwal" value="<?=strtotime($row['BATAS_AWAL_PENILAIAN'])?>" /></td>
	  </tr>
	<tr>
      <td align="right">Batas pernilaian akhir :</td>
	  <?php $dd = explode("-",$row['BATAS_AKHIR_PENILAIAN '])?>
      <td><input id="batasAkhir" class="dtpick" name="batasAkhir" value="<?=strtotime($row['BATAS_AKHIR_PENILAIAN'])?>" /></td>
	  </tr>
