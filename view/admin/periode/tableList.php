...
<tr <?=tag_zebra($z++)?>>
	...
	<td width="10%" align="center"><?=date('d-M-Y', strtotime($row['PERIODE_AWAL']))?></td>
	<td width="10%" align="center"><?=date('d-M-Y', strtotime($row['PERIODE_AKHIR']))?></td>
	<td width="10%" align="center"><?=date('d-M-Y', strtotime($row['BATAS_AWAL_PENILAIAN']))?></td>
	<td width="10%" align="center"><?=date('d-M-Y', strtotime($row['BATAS_AKHIR_PENILAIAN']))?></td>
