...
<div class="padT5"><h3 style="width:300px; text-align:right; display:inline; padding-right:5px">Kriteria : </h3>
	...
	<?php while ($row = mysql_fetch_assoc($kripen)): ?>
		<option value="<?=$row['ID_KRITERIA']?>" <?=$row['ID_KRITERIA']==$kripenID? "selected=\"selected\"" : ""?>><?=$row['NAMA_KRITERIA']?></option>
	<?php endwhile; ?>
	</select>
</div>
<table class="list marginT5" width="100%" border="0" cellpadding="5" cellspacing="0">
  <tr class="header">
    <th width="150" align="left"><h3><span class="colorWhite">Nama Kriteria </span></h3></th>
    <th width="100" align="center"><h3><span class="colorWhite">ID Det. Kriteria</span></h3></th>
    <th width="150" align="left"><h3><span class="colorWhite">Nama Det. Kriteria</span> </h3></th>
