...
<tr <?=tag_zebra($z++)?> ondblclick="penilai_searchKary_pick2('<?= $row["KODE_KARYAWAN"] ?>', '<?= $row["NAMA_KARYAWAN"] ?>', '<?= $row["JABATAN"]["ID_DEP_DIV_JAB"] ?>', '<?= $row["JABATAN"]["NAMA_JABATAN"] ?>', '<?= $row["JABATAN"]["NAMA_DEPARTMENT"] ?>', '<?= $row["JABATAN"]["NAMA_DIVISI"] ?>')" style="cursor:pointer;">
