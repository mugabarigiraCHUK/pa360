...
var DatePicker = new Class({
	...
	onFocus: function(original_input, visual_input) {
		...
		var opt={left:d.left+this.options.positionOffset.x,top:d.top+d.height+this.options.positionOffset.y};
		//if($chk(original_input.getProperty("dtPickerFixedPosition"))){
		//	opt.position="fixed";
		//}
		
		this.show(opt,init_visual_date);
