<?php $GRD = mysql_fetch_assoc(grd_load($gradeID));?>
<?php $periodeID = $GRD['ID_PERIODE'];?>
<form name="frmModal" action="proc/admin/grade.php"> 
<input type="hidden" name="proc" value="22" />
<input type="hidden" name="gradeID" value="<?php echo $GRD['GRD_ID']?>" />
...
<div class="dialog_content">
  	<div style="padding:10px 20px">
		...
		<div class="padT5">
			<div style="width:50px; display:inline-table;">Grade</div> : 
