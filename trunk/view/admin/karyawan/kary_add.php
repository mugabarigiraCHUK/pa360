...
function search_pick(kary_id){
	document.location = 'karyawan.php?sub=kary_edit&kary_id='+kary_id;
}
		...
		<div class="clearBoth padT5">
			...
			<div class="floatL">
				<table width="702" border="0" cellpadding="5" cellspacing="0" class="list">
					...
					<tbody id="alamat-table" style="overflow: scroll; height: 60px;"></tbody>
				</table>
		...
		<div class="clearBoth padT5">
			...
			<div class="floatL">
				<table width="200px" border="0" cellpadding="5" cellspacing="0"  class="list">
					<tr class="header"><td><h3><span class="colorWhite">No. Telpon</span></h3></td><td></td></tr>
					<tbody style="overflow: scroll; height: 60px;" id="tlp-table"></tbody>
				</table>
			</div>
		...
		<div class="clearBoth padT5">
			...
			<div class="floatL">
				<table width="725" border="0" cellpadding="0" cellspacing="0" class="list">
					...
					<tbody id="job-table" style="overflow: scroll; height: 60px;"></tbody>
				</table>
		...
		<div class="clearBoth padT5">
			...
			<div class="floatL">
				<table width="549" border="0" cellpadding="0" cellspacing="0" class="list">
					...
					<tbody id="gol-table" style="overflow: scroll; height: 60px;"></tbody>
				</table>
