...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="list marginT5">
  <tr class="header">
  	<td width="100" align="center"><h3><span class="colorWhite">Level</span></h3></td>
    <td width="100" align="center"><h3><span class="colorWhite">Nama Level</span></h3> </td>
    <td width="100" align="center"><h3><span class="colorWhite">Bobot (%) </span></h3></td>
    <td align="center"><h3><span class="colorWhite">Deskripsi</span></h3></td>
