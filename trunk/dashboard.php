...
if ($_COOKIE_DATA->type == 1 && $_COOKIE_DATA->asAdmin){	//super user
	...
	else if ($p==='laporan_kriteria') { 		include 'view/admin/laporan_standart_kriteria.php'; }
	else if ($p==='laporan_kriteria2') { 		include 'view/admin/laporan_standart_kriteria2.php'; }
