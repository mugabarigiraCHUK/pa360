...
if ($proc==='karyawan-delete'){
	$kode = $_POST['kary_id'];
	$ex = kary_delete_complete($kode);
	echo json_encode(array('error'=> !$ex, 'msg'=> $kode));
}
...
<table style="border:1px solid #457A3F;" width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr class="header">
    <th width="20%"><h3><span class="colorWhite">Kode</span></h3></th>
    <th width="60%"><h3><span class="colorWhite">Nama</span></h3></th>
    <th width="20"><h3><span class="colorWhite">Tgl Masuk</span></h3></th>
  </tr>
  <tbody id="karyawan-search-table">
