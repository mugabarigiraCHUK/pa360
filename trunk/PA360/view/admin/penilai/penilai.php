...
<form id="frmSearch" name="frmSearch" action="proc/penilai.php" method="post">
	...
	<table style="width:100%">
		<tr>
			...
			<td colspan="5"><input id="searchKey" name="searchKey" class="" type="text" style="width:200; background-color:#FFF; border:1px solid #3366CC; color:#000; " disabled="disabled" onchange="penilai_updateJabatanCombo($('frmSearch'));" />
		...
		<tr>
		    ...
		    <td width="160"><input class="" name="departemen" type="text" value="" style="background-color:#FFF; border:1px solid #3366CC; color:#000;" disabled="disabled" /></td>
		    <td width="70px" align="left">Divisi : </td>
		    <td ><input class="" name="divisi" type="text" value="" style="background-color:#FFF; border:1px solid #3366CC; color:#000;" disabled="disabled" /></td>
		</tr>
		<tr>
